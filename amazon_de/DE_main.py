...
def find(m,que_root,que_1):
    ...
    if lis:
        for i in lis:
            w = list()
            au1 = 'https://www.amazon.de' + i.xpath(".//a/@href")[0]
            w.append(au1)
...
def index(url,que_root,que_1):
    ...
    if lis:
        for li in lis:
            au1 = 'https://www.amazon.de' + li.xpath(".//a/@href")[0]
            at0 = li.xpath(".//span[contains(@class,'a-size-small')]/text()")[0]
            at1 = 'Elektronik & Foto' + '/' + at0
...
def main():
    a = [('url','title'),]
    b = []
    url = 'https://www.amazon.de/s/ref=sr_ex_n_1?rh=n%3A562066%2Cp_36%3A0-20000%2Cp_n_availability%3A419126031%2Cp_72%3A419117031&bbn=562066&ie=UTF8&qid='
