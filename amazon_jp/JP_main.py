...
def find(m,que_root,que_1):
    ...
    if lis:
        for i in lis:
            w = list()
            au1 = 'https://www.amazon.co.jp' + i.xpath(".//a/@href")[0]
            w.append(au1)
...
def index(url,que_root,que_1):
    ...
    if lis:
        for li in lis:
            au1 = 'https://www.amazon.co.jp' + li.xpath(".//a/@href")[0]
...
def main():
    a = [('url','title'),]
    b = []
    url = 'https://www.amazon.co.jp/s/ref=sr_nr_p_72_0?fst=as%3Aoff&rh=n%3A3210981%2Cp_n_availability%3A2227307051%2Cp_72%3A82399051&bbn=3210981&ie=UTF8&qid=&rnid=82397051'
