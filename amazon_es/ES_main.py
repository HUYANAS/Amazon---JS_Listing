...
def find(m,que_root,que_1):
    ...
    if lis:
        for i in lis:
            w = list()
            au1 = 'https://www.amazon.es' + i.xpath(".//a/@href")[0]
            w.append(au1)
...
def index(url,que_root,que_1):
    ...
    if lis:
        for li in lis:
            au1 = 'https://www.amazon.es' + li.xpath(".//a/@href")[0]
...
def main():
    a = [('url','title'),]
    url = 'https://www.amazon.es/s/ref=sr_ex_n_1?rh=n%3A599370031%2Cp_n_availability%3A831279031&bbn=599370031&ie=UTF8&qid='
